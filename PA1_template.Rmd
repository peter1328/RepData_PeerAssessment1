...
```{r histogram_with_missings, fig.height=7}
...
```{r steps_per_interval, fig.height=7}
...
#Since this course work is not a high-stakes isuation, I will use a basic imputation method and just impute missing values with daily means
...
````{r histogram_imputed_data, fig.height=7}
...
````{r steps_weekday_weekend, fig.height=7}
